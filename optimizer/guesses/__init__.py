...
make it easy to compare constants, ramps, harmonic pulses, localized pulses, random
smooth pulses, Fourier pulses, and perturbations around known results.
...
from optimizer.guesses.simple import constant_guess, ramp_guess
